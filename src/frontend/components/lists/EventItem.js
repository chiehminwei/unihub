...
const EventItem = ({ event, navigation }) => (
  ...
  <View style={{borderRadius: 20, margin:10, maxWidth:'95%', flex:1 , backgroundColor:'white', shadowOffset:{height:10, width:1}, shadowColor:'grey', shadowOpacity: 0.5,shadowRadius:10, elevation: 3}}> 
